...
const { getIndex, getCreate, postCreate, getEdit, postEdit, postDelete, changeStatus } = require('../controller/Admin.slider.controller');
...
const imageStorage = multer.diskStorage({
    destination: 'public/uploads/slider/images', // Destination to store image 

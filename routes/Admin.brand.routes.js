...
const { getIndex, getCreate, postCreate, getEdit, postEdit, postDelete, changeStatus } = require('../controller/Admin.brand.controller');
...
const imageStorage = multer.diskStorage({
    destination: 'public/uploads/brand/images', // Destination to store image 
